...
let wrapper, toggleMenuHandlerMock;
beforeEach(() => {
  toggleMenuHandlerMock = jest.fn();
  wrapper = shallow(<HamburgerButton toggleMenuHandler={toggleMenuHandlerMock} />);
});
...
describe('<HamburgerButton/>', () => {
  ...
  it('has a correct className when user opened navigation', () => {
    ...
    expect(wrapper.find('button').prop('className')).toEqual('hamburger hamburger--active');
  });
